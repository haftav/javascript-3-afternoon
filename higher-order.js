...
//Code Here
let totalPopulation = populations.reduce((accum, curr) => accum + curr);
...
let bobsTotal = purchases.filter(val => val.owner === 'Bob').reduce((accum, curr) => {return accum + curr.price}, 0)
